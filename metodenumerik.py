# Percobaan metode Regulafalsi,Biseksi, Newton Raphson
...
# Mencetak nilai hasil metode Biseksi
root_bisection = biseksi(f, a, b)
print(f"Akar (Hasil Metode Biseksi): {root_bisection}")

# Mencetak nilai hasil metode Regulafalsi
root_regulafalsi = regulafalsi(f, a, b)
print(f"Akar (Metode Regulafalsi): {root_regulafalsi}")

# Mencetak hasil metode Newton-Raphson
akar = newton_raphson(x0)
print(f"Akar dari f(x) = x - e^(-x) = 0 adalah x = {akar}")
